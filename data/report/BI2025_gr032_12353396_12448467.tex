...
\begin{table}[h]
  ...
  \begin{tabular}{lrrrrl}
    ...
    \midrule
    XGBoost & 0.1540 & 0.1021 & 0.9141 & 1.30 $\star$ \\
...
\begin{itemize}
    ...
    \item \textbf{Training Time:} 5.36 seconds
\end{itemize}
...
\begin{itemize}
    ...
    \item ⚠ \textbf{Hardware Environment:} Training time reported (5.36s), but CPU/GPU specs not documented - performance benchmarks may vary
